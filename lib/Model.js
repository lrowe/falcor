...
function Model(o) {
    ...
    var options = o || {};
    this._eventLog = options.eventLog || options._eventLog;
    ...
    if (this._eventLog) {
        this._eventLog("Model", "constructor", this, [o]);
    }
}
...
Model.prototype.preload = function preload() {
    ...
    var self = this;
    var response = new ModelResponse(function(obs) {
    ...
    if (this._eventLog) {
        this._eventLog("Model", "preload", this, args, response);
    }
    return response;
};
...
Model.prototype.call = function call() {
    ...
    var response = new CallResponse(this, args[0], args[1], args[2], args[3]);
    if (this._eventLog) {
        this._eventLog("Model", "call", this, args, response);
    }
    return response;
};
...
Model.prototype.invalidate = function invalidate() {
    ...
    if (this._eventLog) {
        this._eventLog("Model", "invalidate", this, args);
    }
...
Model.prototype.setCache = function modelSetCache(cacheOrJSONGraphEnvelope) {
    if (this._eventLog) {
        this._eventLog("Model", "setCache", this, [cacheOrJSONGraphEnvelope]);
    }
...
Model.prototype._clone = function cloneModel(opts) {
    ...
    if (this._eventLog) {
        this._eventLog("Model", "_clone", this, [opts], clone);
    }
    return clone;
};
/* eslint-enable */
...
Model.prototype.batch = function batch(schedulerOrDelayArg) {
    ...
    if (this._eventLog) {
        this._eventLog("Model", "batch", this, [schedulerOrDelayArg], clone);
    }
    return clone;
};
...
Model.prototype.unbatch = function unbatch() {
    ...
    if (this._eventLog) {
        this._eventLog("Model", "unbatch", this, [], clone);
    }
    return clone;
};
