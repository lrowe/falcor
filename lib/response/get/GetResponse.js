...
GetResponse.prototype._toJSONG = function _toJSONGraph() {
    var response = new GetResponse(this.model, this.currentRemainingPaths,
                           true, this.isProgressive, this.forceCollect);
    if (this.model._eventLog) {
        this.model._eventLog("GetResponse", "_toJSONG", this, [], response);
    }
    return response;
};
...
GetResponse.prototype.progressively = function progressively() {
    ...
    if (this.model._eventLog) {
        this.model._eventLog("GetResponse", "progressively", this, [], response);
    }
    return response;
};
